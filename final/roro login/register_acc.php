...
if(isset($_POST['register']))
{
   ...
   $check_sql = "SELECT username FROM users WHERE username='$username'";
    ...
    {
        $addusersql = "INSERT INTO users (`ID`, `firstname`, `lastname`, `username`, `password`, `role`, `grade1`, `grade2`, `grade3`, `grade4`, `grade5`, `grade6`, `grade7`)
        VALUES (null, '$firstname', '$lastname', '$username', '$password', '$role', '$grade1', '$grade2', '$grade3', '$grade4', '$grade5', '$grade6', '$grade7')";
